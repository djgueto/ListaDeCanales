...
limpiar_dir_tmp() {
	...
	then
		...
		borrar_directorio "${DIR_TMP}/picon-movistar"
                borrar_directorio "${DIR_TMP}/ListaDeCanales"
		...
		borrar_fichero "${DIR_TMP}/ListaDeCanales.zip"
...
actualizar_listacanales(){
	...
	'astra')
		URL=https://github.com/djgueto/ListaDeCanales/archive/master.zip
...
pre_actualizar_junglescript(){
	URL=https://github.com/djgueto/ListaDeCanales/blob/master/enigma2_pre_start.sh
